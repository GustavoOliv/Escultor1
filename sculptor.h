 ...
 * Armazena os valores das cores e alpha que é a tranparência
 * E se é ativo ou não
 */
struct Voxel
{
...
public:
  ...
  ~Sculptor();
  /**
   * @brief setColor Define a cor
   * @param r Recebe float que será o valor da cor vermelha
   * @param g Recebe float que será o valor da cor verde
   * @param b Recebe float que será o valor da cor azul
   * @param alpha Recebe float que será o valor da transparência
   */
   ...
   * @param y1 valor final de y
   * @param z0 valor inicial de z
   * @param z1 valor final de z
   */
  ...
  /**
   * @brief writeOFF
   * @param filename Recebe o nome do arquivo, abre e escreve dentro dele os vertices e faces
   */
